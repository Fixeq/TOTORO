...
public class StringUtil {
	...
	public static String renderPaging(int totalCnt,int pageNum,int pageSize
		...
		html.append("<ul>");
		   ...
		   if (maxPageNo >= inx) {
		    html.append("<li>");
		    html.append("<a class=\"pgn__num\" href=\"javascript:" + scriptName + "('" + url + "'," + maxPageNo+ ");\">      \n");
		    html.append("&raquo;     \n");
		    html.append("</a>    \n");
		    html.append("</li>");
		   }
...
//		</select>
	...
	public static String makeSelectBoxForBootStrap(List<CodeVO> list,String selectCode,String selectNm,boolean allYN){
...
//		</select>
		StringBuilder sb=new StringBuilder();
		sb.append("<select name='"+selectNm+"' id='"+selectNm+"' class='form-control input-sm dohyeonForCheck'>\n");		
		//전체
		if(true == allYN){
			sb.append("<option value=''>::전체::</option> \n");
		}
