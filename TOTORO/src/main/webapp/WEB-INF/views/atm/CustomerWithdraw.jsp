  ...
  table {
	...
	<form  name="frm" id="frm" action="customerdeposit.do" method="get" class="form-inline">
									...
									<c:forEach var="AtmVo" items="${list}">
										...
										<tr>
										   <td class="text-center"><input type="checkbox" id="check" name="check"></td>
											...
											<td class="text-left"><c:out value="${AtmVo.wiPoint}"></c:out></td>
        ...
        function doSearch(){
       	 ...
       	 frm.search_word ="customerwithdraw.do";
         ...
         function doReqSearch(){
        	 var frm = document.frm;
        	 frm.page_num.value =1;
        	 frm.search_word ="cuswithdrawreq.do";
         ...
         function doPsSearch(){
        	 var frm = document.frm;
        	 frm.page_num.value =1;
        	 frm.search_word ="cuswithdrawps.do";
